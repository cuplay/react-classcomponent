...
var BasePlot = /** @class */ (function (_super) {
    ...
    BasePlot.prototype.componentDidMount = function () {
        ...
        this.preConfig = pickWithout(this.props, __spreadArrays(REACT_PIVATE_PROPS, [
            'container',
            'PlotClass',
            'onGetG2Instance',
            'data',
    ...
    BasePlot.prototype.checkInstanceReady = function () {
        if (!this.g2Instance) {
            ...
            var options = pickWithout(this.props, [
                'container',
                'PlotClass',
                'onGetG2Instance',
                'children',
...
function createPlot(PlotClass, name, transCfg) {
    ...
    var Com = React.forwardRef(function (props, ref) {
        ...
        var resizeFn = useCallback(function () {
            ...
            var titleSize = titleDom.current ? getElementSize(titleDom.current) : { width: 0, height: 0 };
        ...
        var FallbackComponent = React.isValidElement(errorContent) ? function () { return errorContent; } : errorContent;
        ...
        if (placeholder && !realCfg.data) {
            ...
            return React.createElement(ErrorBoundary, __assign({ FallbackComponent: FallbackComponent }, ErrorBoundaryProps),
                React.createElement("div", { style: { width: props.width || '100%', height: props.height || 400, textAlign: 'center', position: 'relative' } }, pl));
        }
        ...
        return React.createElement(ErrorBoundary, __assign({ FallbackComponent: FallbackComponent }, ErrorBoundaryProps),
            React.createElement("div", { ref: container, className: "bizcharts-plot", style: { position: 'relative', height: props.height || '100%', width: props.width || '100%' } },
