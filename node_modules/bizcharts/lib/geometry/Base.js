...
var GeomHelper = /** @class */ (function () {
    ...
    GeomHelper.prototype.update = function (newConfig, component) {
        ...
        if (!this.geom) {
            ...
            var sortable = newConfig.sortable, visible = newConfig.visible, connectNulls = newConfig.connectNulls;
            var cfg = { sortable: sortable, visible: visible, connectNulls: connectNulls };
            // 如果是时间类型则对数据排序
            this.createGeomInstance(component.GemoBaseClassName, cfg);
            this.interactionTypes = component.interactionTypes;
        }
        compareProps_1.default(this.config, newConfig, ['position', 'shape', 'color', 'label', 'style', 'tooltip', 'size', 'animate', 'state'], function (value, key) {
            var _a;
            // value 已被转为array
