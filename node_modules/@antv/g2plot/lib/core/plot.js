...
var Plot = /** @class */ (function (_super) {
    ...
    Plot.prototype.createG2 = function () {
        var _a = this.options, width = _a.width, height = _a.height, padding = _a.padding, appendPadding = _a.appendPadding, renderer = _a.renderer, pixelRatio = _a.pixelRatio, syncViewPadding = _a.syncViewPadding, supportCSSTransform = _a.supportCSSTransform, limitInPlot = _a.limitInPlot;
        this.chart = new g2_1.Chart(tslib_1.__assign(tslib_1.__assign({ container: this.container, autoFit: false }, this.getChartSize(width, height)), { padding: padding,
